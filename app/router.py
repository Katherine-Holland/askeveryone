...
5) CODING_TECH: OPENAI > CLAUDE > LLAMA > HUGGINGFACE
6) DATA_MATH_QUANT: OPENAI > CLAUDE > LLAMA
7) WRITING_EDITING_MARKETING: CLAUDE > OPENAI > LLAMA
8) CREATIVE_BRAINSTORM: OPENAI > CLAUDE > LLAMA
9) RECOMMENDATION_NONLOCAL: OPENAI > CLAUDE > PERPLEXITY > GEMINI
10) SENSITIVE_GUARDED: CLAUDE > OPENAI > PERPLEXITY (citations only)
11) GENERAL_CHAT: OPENAI > CLAUDE > LLAMA
